...
namespace EmuDisk
{
    internal partial class BitControl : UserControl
    {
        ...
        public BitControl()
        {
            ...
            for (int i = 7; i > -1; i--)
            {
                ...
                lbl.Name = "lbl" + i.ToString(CultureInfo.CurrentCulture);
                lbl.Size = new System.Drawing.Size(14, 14);
                lbl.Text = i.ToString(CultureInfo.CurrentCulture);
            ...
            for (int i = 7; i > -1; i--)
            {
                ...
                txt.MaxLength = 1;
                txt.Multiline = false;
                txt.Name = "txt" + i.ToString(CultureInfo.CurrentCulture);
