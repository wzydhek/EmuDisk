...
namespace EmuDisk
{
    ...
    internal class FindOptions
    {
        ...
        void UpdateFindBuffer()
        {
            ...
            FindBufferLowerCase = ASCIIEncoding.ASCII.GetBytes(text.ToLower(CultureInfo.CurrentCulture));
            FindBufferUpperCase = ASCIIEncoding.ASCII.GetBytes(text.ToUpper(CultureInfo.CurrentCulture));
        }
    }
}
