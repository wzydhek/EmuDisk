...
namespace EmuDisk
{
    ...
    internal class HexBox : Control
    {
        ...
        /// Occurs, when the value of ReadOnly property has changed.
        /// </summary>
        [Description("Occurs, when the value of FixedLength property has changed.")]
        public event EventHandler FixedLengthChanged;
        /// <summary>
        ...
        /// <summary>
        /// Raises the FixedLengthChanged event.
        /// </summary>
        /// <param name="e">An EventArgs that contains the event data.</param>
        protected virtual void OnFixedLengthChanged(EventArgs e)
        {
            if (FixedLengthChanged != null)
                FixedLengthChanged(this, e);
        }
